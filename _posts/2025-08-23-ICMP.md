...
3. [GitHub Project Structure](#github-project-structure)
4. [Raw Sockets](#raw-sockets)  
5. [Sending ICMP Echo Request](#sending-icmp-echo-request)
6. [Capturing ICMP Echo Reply](#capturing-icmp-echo-reply)
7. [Summary](#Summary)
...
## Summary
We built a simple Ping tool in Python using ICMP packets and raw sockets.

- ICMP helps test network connectivity.

- TTL prevents endless packet forwarding.

- With raw sockets, Python can send and receive low-level ICMP packets.

- We created an ICMP Echo Request, sent it, and captured the Echo Reply.

This project is a great way to understand how ping works under the hood and how protocols interact at the network layer.

🔗 Full code is available on GitHub: [melvinjosemt/myping](https://github.com/melvinjosemt/myping)